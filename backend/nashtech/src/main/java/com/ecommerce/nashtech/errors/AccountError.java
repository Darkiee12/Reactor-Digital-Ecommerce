...
import com.ecommerce.nashtech.errors.AccountError.ExpiredTokenError;
...
@Getter
public sealed abstract class AccountError implements BaseError permits
    UserError,
    ...
    AccountError.NotValidPassword, ExpiredTokenError
{
