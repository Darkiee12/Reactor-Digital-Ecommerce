...
public interface IUserController {
    ...
    public Mono<ResponseEntity<String>> getUserByUuid(
        ...
        @Parameter(description = "UUID of the user to retrieve", required = true, schema = @Schema(type = "string", format = "uuid", example = "d290f1ee-6c54-4b01-90e6-d701748f0851"))
        UUID uuid
    );
    ...
    public Mono<ResponseEntity<String>> getUserByUsername(
        ServerWebExchange exchange,
        @Parameter(description = "Username of the user to retrieve", required = true, schema = @Schema(type = "string", example = "username"))
        String username
    );
    ...
    public Mono<ResponseEntity<String>> getUserByEmail(
        ServerWebExchange exchange,
        @Parameter(description = "Email of the user to retrieve", required = true, schema = @Schema(type = "string", format = "email", example = "user@email.com"))
        String email
    );

    @Operation(summary = "Create a new user", description = "Create a new user")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Create successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = LoginResponse.class))),
    ...
    public Mono<ResponseEntity<String>> createUser(
        ServerWebExchange exchange,
        @Parameter(description = "User information to create", required = true, schema = @Schema(implementation = CreateUserDto.class))
        CreateUserDto dto
    );
    ...
    public Mono<ResponseEntity<String>> updateUserByUuid(
        ServerWebExchange exchange,
        @Parameter(description = "UUID of the user to update", required = true, schema = @Schema(type = "string", format = "uuid", example = "d290f1ee-6c54-4b01-90e6-d701748f0851"))
        UUID uuid,
        @Parameter(description = "User information to update", required = true, schema = @Schema(implementation = UpdateUserDto.class))
        UpdateUserDto dto
    );
    ...
    public Mono<ResponseEntity<String>> updateUserByUsername(
        ServerWebExchange exchange,
        @Parameter(description = "Username of the user to update", required = true, schema = @Schema(type = "string", example = "username"))
        String username,
        @Parameter(description = "User information to update", required = true, schema = @Schema(implementation = UpdateUserDto.class))
        UpdateUserDto dto
    );
    ...
    public Mono<ResponseEntity<String>> updateUserByEmail(
        ServerWebExchange exchange,
        @Parameter(description = "Email of the user to update", required = true, schema = @Schema(type = "string", format = "email", example = "user@email.com"))
        String email,
        @Parameter(description = "User information to update", required = true, schema = @Schema(implementation = UpdateUserDto.class))
        UpdateUserDto dto
    );
    ...
    public Mono<ResponseEntity<String>> deleteUserByUsername(
        ServerWebExchange exchange,
        @Parameter(description = "Username of the user to delete", required = true, schema = @Schema(type = "string", example = "username"))
        String username
    );
    ...
    public Mono<ResponseEntity<String>> deleteUserByEmail(
        ServerWebExchange exchange,
        @Parameter(description = "Email of the user to delete", required = true, schema = @Schema(type = "string", format = "email"))
        String email
    );
